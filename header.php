...
$redirectUri = 'https://itsfashionworld.com/index.php';
...
if (isset($_GET['code']) && isset($google)) {
  ...
  $id = $google_account_info->id;
    ...
    header("Location: https://itsfashionworld.com/index.php");
  // now you can use this profile info to create account in your website and make user logged in.
    ...
    if (isset($_GET['code'])) {
      ...
      header("Location: https://itsfashionworld.com");
...
<html lang="en">
    <head>
        ...
        <title>It's Fashion World - Think beyond</title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="tb-contact">
                            <p><i class="fas fa-envelope"></i>itsfashionworld2021@mail.com</p>
                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="social ml-auto">
                            ...
                            <a href="https://twitter.com/FashionworldIts?s=09" target="_blank"><i class="fab fa-twitter"></i></a>
                            <a href="https://www.facebook.com/Itsfashionworld-108728444843072" target="_blank"><i class="fab fa-facebook-f"></i></a>
                            <a href="https://www.linkedin.com/company/itsfashionworld/" target="_blank"><i class="fab fa-linkedin-in"></i></a>
                            <a href="https://www.instagram.com/itsf_ashionworld/" target="_blank"><i class="fab fa-instagram"></i></a>
                            <a href="https://www.youtube.com/channel/UCkC8mkDKDTPvlwzRJWAe44Q" target="_blank"><i class="fab fa-youtube"></i></a>
                        </div>
                    </div>
                </nav>
            </div>
